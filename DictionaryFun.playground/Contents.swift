...
if let anotherCapital = states["Pennsylvania"] {
    print("The capital of PA is  \(anotherCapital).")
} else {
...
print("Pennsylvania's capital is \(states["Pennsylvania"]!)")
...
print("The capital of \(state) is \(states["New York"]!).")
...
"The Beatles": ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
"The Breeders": ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
"Pixies": ["Frank Black", "Joey Santiage", "Kim Deal", "David Lovering"]
]
